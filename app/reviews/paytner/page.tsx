...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/reviews/paytner/",
  },
  openGraph: {
    title:
      "ペイトナーの口コミ・評判｜最短10分のフリーランス向けファクタリングを検証",
    ...
    url: "https://hyogo-shihoushoshi.jp/reviews/paytner/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://hyogo-shihoushoshi.jp/reviews/paytner/",
  },
};
    ...
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <section className="mb-10 rounded-xl border border-primary/30 bg-primary/5 p-6">
          <p className="mb-3 text-sm font-bold text-primary">ペイトナーをさらに詳しく</p>
          <ul className="grid gap-2 text-sm md:grid-cols-3">
            <li><Link href="/reviews/paytner/shinsa/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">審査は厳しい？通過のコツ</Link></li>
            <li><Link href="/reviews/paytner/documents/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">必要書類と入金までの流れ</Link></li>
            <li><Link href="/reviews/paytner/fee/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">手数料の実際と他社比較</Link></li>
          </ul>
        </section>
        ...
        <section id="reviews" className="mb-16">
          ...
          <div className="mb-8 rounded-lg border border-border bg-section-bg p-4 text-xs text-text-light leading-relaxed">
            ...
            <p className="text-xs text-gray-400 mt-2">出典: <a href="https://faclog.jp/factor/paytnerfactoring" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600">ファクログ</a> / <a href="https://minhyo.jp/" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600">みん評</a></p>
          </div>
