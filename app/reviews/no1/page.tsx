...
export const metadata: Metadata = {
  title:
    "株式会社No.1の口コミ・評判｜最短即日・手数料0.5%〜のファクタリング",
  description:
    "株式会社No.1の口コミ・評判を徹底調査。最短即日入金、手数料0.5%〜15%、買取額50万〜5,000万円で法人・個人事業主対応のファクタリングを利用者の声で検証します。",
  alternates: {
  ...
  openGraph: {
    title:
      "株式会社No.1の口コミ・評判｜最短即日・手数料0.5%〜のファクタリング",
    description:
      "株式会社No.1の口コミ・評判を徹底調査。手数料0.5%〜15%のファクタリングを検証。",
...
const basicInfo = [
  { label: "手数料", value: "0.5%〜15%（公式サイトにて2026年6月確認）" },
...
const goodReviews = [
  {
    title: "手数料が思ったより安かった",
    detail:
      "建設業の利用者からは「想定より低い手数料で利用できた」「上限近くを覚悟していたが実際は抑えられた」という声があります。公式サイトでは手数料0.5%〜15%（公式サイトにて2026年6月確認）と案内されており、売掛先の信用力や取引実績によって低い手数料が適用されるケースが多いようです。",
  },
  {
    title: "対応のスピードが速い",
    detail:
...
const badReviews = [
  {
    ...
    detail:
      "サービス業の利用者からは「0.5%〜15%の幅が広すぎて事前にコストが読めなかった」「見積もりを取るまで手数料がわからないのは不便」という声があります。事前に無料見積もりで確認する必要があります。",
  },
  {
...
const merits = [
  {
    title: "手数料0.5%〜の低水準",
    description:
      "公式サイトでは手数料0.5%〜15%（公式サイトにて2026年6月確認）と案内されており、下限0.5%という低水準が魅力です。3社間ファクタリングの場合はさらに低い手数料が適用される傾向があり、売掛先の信用力次第で上限近くにならずに利用できるケースもあります。",
  },
  {
    title: "2社間・3社間の両方に対応",
    description:
      "2社間と3社間の両方のファクタリングに対応しているため、取引先との関係性や手数料のバランスを考慮して最適な方式を選択できます。手数料を重視するなら3社間、秘密保持を重視するなら2社間と使い分けが可能です。方式ごとの具体的な手数料率は公式サイトで明示されていないため、詳細は公式サイトでご確認ください。",
  },
  {
    title: "最短即日の迅速な入金",
    description:
...
const demerits = [
  {
    title: "手数料の幅が広い（0.5%〜15%）",
    description:
      "公式サイトでは手数料0.5%〜15%（公式サイトにて2026年6月確認）と幅広く設定されているため、実際にいくらになるかは見積もりを取るまでわかりません。下限0.5%が適用される条件は限定的なため、正確な手数料は無料見積もりで確認する必要があります。",
  },
  {
...
const faqs = [
  {
    ...
    answer:
      "公式サイトでは手数料0.5%〜15%（公式サイトにて2026年6月確認）と案内されています。実際の手数料は2社間か3社間か、売掛先の信用力、売掛金の金額、支払いサイトなどにより決まります。方式ごとの内訳は公式サイトで明示されていないため、詳細は公式サイトでご確認のうえ、無料見積もりで正確な手数料を確認してください。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "3社間ファクタリングは売掛先の同意が必要ですが、その分手数料を抑えやすくなります。取引先の理解が得られる場合はコストを大きく抑えられ、売掛先が大手企業の場合は特に有利です。方式ごとの具体的な手数料率は公式サイトで明示されていないため、詳細は公式サイトでご確認ください。",
  },
  {
...
const comparisonData = [
  { name: "株式会社No.1", fee: "0.5%〜15%", speed: "最短即日", amount: "50万〜5,000万円", online: "○" },
      ...
      <section className="bg-primary-light py-12 md:py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <h1 className="text-2xl font-bold leading-tight text-primary md:text-4xl">
            ...
            最短即日・手数料0.5%〜のファクタリング
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-base text-text-light md:text-lg">
            手数料0.5%〜15%、最短即日入金の「株式会社No.1」の口コミ・評判を徹底調査。法人・個人事業主対応のファクタリングサービスを検証します。
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <div className="mb-8 rounded-xl border-2 border-primary/30 bg-primary-light/40 p-5 md:p-6">
          ...
          <p className="text-sm leading-relaxed text-text-main">
            株式会社No.1は、2社間・3社間を比較検討しながら、対面でのコンサルティングも受けて進めたい法人・個人事業主に向いたサービスです。手数料は0.5%〜15%（公式サイトにて2026年6月確認）で、50万〜5,000万円の売掛金を最短即日で資金化できます。一方、手数料の幅が広く事前にコストを確定しにくい点と、買取上限5,000万円のため大口案件には不向きです。
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="mb-4 leading-relaxed text-text-light">
            株式会社No.1は、法人・個人事業主向けにファクタリングサービスを提供する会社です。公式サイトでは手数料0.5%〜15%（公式サイトにて2026年6月確認）という幅広い料金設定で、2社間・3社間の両方のファクタリングに対応しています。
          </p>
          <p className="mb-4 leading-relaxed text-text-light">
          ...
          <div className="rounded-lg border border-secondary/30 bg-teal-50 p-6">
            ...
            <ul className="space-y-2 text-sm text-text-light">
              <li className="flex items-start gap-2">
                ...
                <span>手数料0.5%〜15%で2社間・3社間の両方に対応</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-0.5 text-secondary">&#10003;</span>
          ...
          <div className="space-y-4">
            <div className="rounded-lg border border-border bg-white p-5">
              ...
              <p className="text-sm leading-relaxed text-text-light">
                取引先にファクタリングの利用を知られたくない場合は2社間がおすすめです。一般に2社間は3社間より手数料が高めになりますが、売掛先への通知が不要で、手続きも比較的スピーディーに進みます。秘密保持を重視する方に最適です。方式ごとの具体的な手数料率は公式サイトで明示されていないため、詳細は公式サイトでご確認ください。
              </p>
            </div>
            <div className="rounded-lg border border-border bg-white p-5">
              <p className="mb-2 font-semibold text-text-main">3社間ファクタリングが向いている場合</p>
              <p className="text-sm leading-relaxed text-text-light">
                手数料を最小限に抑えたい場合は3社間がおすすめです。売掛先の同意が必要ですが、一般に2社間より手数料を抑えやすくなります。売掛先が大手企業で理解が得やすい場合や、既にファクタリングの利用が取引先に認知されている場合に有利です。方式ごとの具体的な手数料率は公式サイトで明示されていないため、詳細は公式サイトでご確認ください。
              </p>
            </div>
            <div className="rounded-lg border border-border bg-white p-5">
        ...
        <section className="mb-16">
          ...
          <p className="mb-4 leading-relaxed text-text-light">
            株式会社No.1は、2社間・3社間の両方に対応し、公式サイトでは手数料0.5%〜15%（公式サイトにて2026年6月確認）の幅広い料金設定で多様なニーズに応えるファクタリングサービスです。特に対面でのコンサルティング対応が充実しており、初めてのファクタリング利用者でも安心して相談できます。
          </p>
          <p className="mb-4 leading-relaxed text-text-light">
            3社間ファクタリングを利用すれば手数料を抑えやすく、コストを重視する事業者にとっても魅力的な選択肢です（方式ごとの具体的な手数料率は公式サイトで明示されていないため、詳細は公式サイトでご確認ください）。最短即日入金のスピード感も評価されています。
          </p>
