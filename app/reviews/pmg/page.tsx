...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/reviews/pmg/",
  },
  openGraph: {
    title:
      "PMGの口コミ・評判｜年間取引8,600件の大手ファクタリングを検証",
    ...
    url: "https://hyogo-shihoushoshi.jp/reviews/pmg/",
    type: "article",
  },
};
...
const basicInfo = [
  { label: "手数料", value: "2%〜（買取率最大98%）／上限は個別査定・非公開。詳細は公式サイトで（公式サイトにて2026年6月確認）" },
...
const badReviews = [
  {
    ...
    detail:
      "「2社間の手数料が想定より高かった」「他社と比較すると手数料が高めだった」という声があります。手数料は2%〜（買取率最大98%）と公式に案内されていますが、下限が適用される条件は限定的なようです。具体的な手数料は売掛先の状況や条件により個別査定となるため、詳細は公式サイトで確認しましょう。",
  },
  {
    title: "アポなし営業の報告がある",
    detail:
...
const demerits = [
  {
    title: "手数料の上限が公開されていない",
    description:
      "PMGの手数料は公式に2%〜（買取率最大98%）と案内されていますが、上限は公開されておらず個別査定です。特に少額案件や売掛先の信用力が低い場合は、手数料が高くなる可能性があります。必ず見積もりで正確な手数料を確認しましょう。詳細は公式サイトで確認できます。",
  },
  {
    title: "営業活動が積極的",
    description:
...
const faqs = [
  {
    ...
    answer:
      "公式サイトでは手数料2%〜（買取率最大98%）と案内されており、上限は公開されず案件ごとに個別査定されます。手数料は売掛先の信用力、売掛金の金額、支払いサイトなどにより変動します。最低手数料の2%が適用されるのは好条件の案件に限られるため、正確な手数料は見積もり・公式サイトで確認してください。",
  },
  {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://hyogo-shihoushoshi.jp/reviews/pmg/",
  },
};
...
const comparisonData = [
  { name: "PMG", fee: "2%〜（上限非公開）", speed: "最短即日", amount: "制限なし", security: "Pマーク/ISO27001" },
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <div className="mb-8 rounded-xl border-2 border-primary/30 bg-primary-light/40 p-5 md:p-6">
          ...
          <p className="text-sm leading-relaxed text-text-main">
            PMGは年間取引8,600件以上の実績と、Pマーク・ISO27001のダブル認証による万全なセキュリティ体制を持つ大手ファクタリング会社です。大口案件に強く、来店・出張・オンラインの柔軟な対応が可能なため、情報セキュリティや実績、対面での丁寧な対応を重視する法人に向いています。一方で手数料は公式に2%〜（買取率最大98%）と案内され上限は非公開・個別査定のため、営業連絡が積極的な点とあわせて事前に理解しておきましょう。
          </p>
        ...
        <section id="reviews" className="mb-16">
          ...
          <div className="mb-8 rounded-lg border border-border bg-section-bg p-4 text-xs text-text-light leading-relaxed">
            ...
            <p className="text-xs text-gray-400 mt-2">出典: <a href="https://faclog.jp/factor/pmg" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600">ファクログ</a> / <a href="https://growth-partners.co.jp/pmg-reputation/" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600">GROWTH PARTNERS</a></p>
          </div>
        ...
        <section className="mb-16">
          ...
          <p className="leading-relaxed text-text-light">
            一方で、手数料は公式に2%〜（買取率最大98%）と案内され上限が非公開・個別査定である点や、営業活動が積極的な点は事前に理解しておく必要があります。セキュリティと実績を重視し、多少の営業連絡は許容できる方にはおすすめのサービスです。
          </p>
        </section>
