...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://hyogo-shihoushoshi.jp/reviews/factoru/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://hyogo-shihoushoshi.jp/reviews/factoru/",
  },
};
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <div className="mb-8 rounded-xl border-2 border-primary/30 bg-primary-light/40 p-5 md:p-6">
          ...
          <p className="text-sm leading-relaxed text-text-main">
            ファクトルは、AI審査による最短40分入金と手数料1.5%〜（公式サイトにて2026年6月確認）で、スピードと手数料の両方を重視しつつ完全オンラインで手続きしたい法人・個人事業主に向いたサービスです。買取可能額は30万〜1億円で、2社間ファクタリングのため売掛先に通知されずに利用できます。一方、最低手数料の適用は好条件が揃った場合に限られ、対面サポートや3社間ファクタリングには対応していません。
          </p>
