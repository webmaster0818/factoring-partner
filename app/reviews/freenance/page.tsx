...
const basicInfo = [
  { label: "手数料", value: "3%〜10%（公式サイトにて2026年6月確認。フリーナンス口座を受取先に設定しない場合は一律10%）" },
...
const demerits = [
  ...
  },
  {
    ...
    description:
      "手数料3%〜10%の範囲（公式サイトにて2026年6月確認）ですが、初回利用時や与信実績が少ない段階では上限に近い手数料が適用されるケースが多いです。継続利用で与信が上がると手数料が下がる仕組みのため、長期的な利用を前提とした設計です。",
  },
  {
...
const faqs = [
  {
    ...
    answer:
      "公式サイトによると手数料は3〜10%の範囲です（公式サイトにて2026年6月確認）。フリーナンス口座を報酬の受取先に設定した場合は与信スコア等に応じて3〜10%の間で変動し、設定しない場合は一律10%です。初回利用時は上限に近い手数料になることが多いですが、継続利用で与信が積み上がると手数料が低下する仕組みです。詳細は公式サイトでご確認ください。",
  },
  {
...
const comparisonData = [
  { name: "FREENANCE", fee: "3%〜10%（2026年6月確認）", speed: "最短即日", amount: "1万円〜", online: "◎" },
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <div className="mb-8 rounded-xl border-2 border-primary/30 bg-primary-light/40 p-5 md:p-6">
          ...
          <p className="text-sm leading-relaxed text-text-main">
            FREENANCE（フリーナンス）は、GMOクリエイターズネットワークが運営するフリーランス・個人事業主特化の「即日払い」ファクタリングです。最大の特徴は、会員登録だけで損害賠償保険「あんしん補償」が無料で自動付帯すること。手数料は3〜10%（公式サイトにて2026年6月確認）で、1万円からの少額利用にも対応します。ただし即日払いの対象は法人からの売掛金のみで、初回は手数料が高めになりがちな点に注意が必要です。
          </p>
        ...
        <section className="mb-10 rounded-xl border border-primary/30 bg-primary/5 p-6">
          <p className="mb-3 text-sm font-bold text-primary">フリーナンスをさらに詳しく</p>
          <ul className="grid gap-2 text-sm md:grid-cols-3">
            <li><Link href="/reviews/freenance/shinsa/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">審査は厳しい？通過のコツ</Link></li>
            <li><Link href="/reviews/freenance/documents/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">必要書類と入金までの流れ</Link></li>
            <li><Link href="/reviews/freenance/fee/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">手数料の実際と他社比較</Link></li>
          </ul>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="mb-4 leading-relaxed text-text-light">
            手数料3〜10%（公式サイトにて2026年6月確認）は業界標準の水準ですが、継続利用で与信が上がるほど手数料が下がる仕組みのため、長期的にはコストパフォーマンスの高いサービスです。GMOグループ運営の安心感も大きなメリットです。
          </p>
