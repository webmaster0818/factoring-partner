...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://hyogo-shihoushoshi.jp/reviews/dokenkun/",
  },
  openGraph: {
    title:
      "土建くんの口コミ・評判｜建設業特化ファクタリングを検証",
    ...
    url: "https://hyogo-shihoushoshi.jp/reviews/dokenkun/",
    type: "article",
  },
};
...
const basicInfo = [
  ...
  { label: "手数料", value: "1.8%〜（上限非公開・公式サイトにて2026年6月確認）" },
...
const badReviews = [
  ...
  },
  {
    title: "手数料の上限が不明瞭",
    detail:
      "「手数料1.8%〜と下限のみ公開されており、実際にどのくらいの手数料になるか事前にわかりにくい」という指摘があります。具体的な手数料は案件ごとに異なるため、見積もりを取るまで正確な費用がわからない点に注意が必要です。",
  },
  {
    title: "知名度がまだ低い",
    detail:
...
const demerits = [
  ...
  },
  {
    title: "手数料の上限が非公開",
    description:
      "手数料は1.8%〜と下限のみ公開されており、上限が明示されていません（公式サイトにて2026年6月確認）。案件ごとに手数料が異なるため、見積もりを取るまで具体的なコストがわからない点はデメリットです。他社と比較する際は、必ず見積もりを取って実際の手数料を確認しましょう。",
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "土建くんの手数料は1.8%〜とされています（公式サイトにて2026年6月確認）。具体的な手数料は案件ごとに異なります。売掛先の信用力（元請・ゼネコンなど）、売掛金の金額、支払いサイトなどによって変動するため、正確な手数料を知るには見積もりを取る必要があります。見積もりは無料です。",
  },
  {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://hyogo-shihoushoshi.jp/reviews/dokenkun/",
  },
};
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <div className="mb-8 rounded-xl border-2 border-primary/30 bg-primary-light/40 p-5 md:p-6">
          ...
          <p className="text-sm leading-relaxed text-text-main">
            土建くんは、建設業の商慣習（支払いサイトの長さや重層下請構造）を理解した審査で、一人親方を含む建設業の事業者が元請に知られず（2社間）資金調達したい場合に向いたサービスです。手数料は1.8%〜（上限非公開・公式サイトにて2026年6月確認）で、最短即日入金に対応します。一方、建設業以外の業種の方や、手数料の上限を事前に把握したい方、大手の実績を重視する方には不向きです。
          </p>
