...
export const metadata: Metadata = {
  ...
  description:
    "メンターキャピタルの口コミ・評判を徹底調査。小口対応、最短即日入金、手数料2%〜、法人・個人事業主対応のファクタリングを利用者の声で検証します。",
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/reviews/mentor/",
  },
  openGraph: {
    title:
      "メンターキャピタルの口コミ・評判｜300万円以下の小口ファクタリング",
    ...
    url: "https://hyogo-shihoushoshi.jp/reviews/mentor/",
    type: "article",
  },
};
...
const basicInfo = [
  { label: "手数料", value: "2%〜（上限非公開・公式サイトにて2026年6月確認）" },
...
const badReviews = [
  {
    title: "手数料がやや高めに感じた",
    detail:
      "IT企業の経営者からは「手数料2%〜とあるが実際の見積もりはもう少し高かった」「オンライン完結型のサービスと比べるとコストが高く感じた」という声があります。実際の手数料は売掛金額や契約方式により変動します。",
  },
  {
...
const demerits = [
  {
    title: "小口案件は手数料率が高くなりやすい",
    description:
      "公式の手数料は2%〜（上限非公開・公式サイトにて2026年6月確認）ですが、一般にファクタリングは売掛金額が小さいほど手数料率が高くなる傾向があります。小口案件では下限よりも高い料率が適用されるケースがあるため、実際の手数料は見積もりで必ず確認しましょう。詳細は公式サイトでご確認ください。",
  },
  {
    title: "完全オンライン完結ではない",
    description:
...
const faqs = [
  {
    ...
    answer:
      "公式サイトによると手数料は2%〜（上限非公開・公式サイトにて2026年6月確認）で、売掛先の信用力・売掛金の金額・支払いサイト・2社間か3社間かなどにより決定されます。小口案件では下限より高い料率になる場合があるため、正確な手数料は見積もりでご確認ください。詳細は公式サイトでご確認ください。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "3社間ファクタリングは売掛先の同意が必要ですが、手数料が大幅に低くなるメリットがあります。公式の手数料は2%〜（上限非公開・公式サイトにて2026年6月確認）で、手数料を重視する場合は3社間を検討する価値があります。売掛先が大手企業の場合は特に有利です。詳細は公式サイトでご確認ください。",
  },
];
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://hyogo-shihoushoshi.jp/reviews/mentor/",
  },
};
...
const comparisonData = [
  { name: "メンターキャピタル", fee: "2%〜", speed: "最短即日", amount: "30万〜1億円", online: "○" },
      ...
      <section className="bg-primary-light py-12 md:py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-text-light md:text-lg">
            小口ファクタリングに強い「メンターキャピタル」の口コミ・評判を徹底調査。手数料2%〜、最短即日入金のサービスを検証します。
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <div className="mb-8 rounded-xl border-2 border-primary/30 bg-primary-light/40 p-5 md:p-6">
          ...
          <p className="text-sm leading-relaxed text-text-main">
            メンターキャピタルは、300万円以下の小口案件を丁寧に対応してほしい中小企業・個人事業主に向いたファクタリングサービスです。手数料は公式表記で2%〜（上限非公開・公式サイトにて2026年6月確認）、買取可能額は30万〜1億円で、最短即日入金と2社間・3社間の両方に対応します。一方、完全オンラインでは完結しない場合があり、手数料の安さを最重視する方には向きません。
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="mb-4 leading-relaxed text-text-light">
            2社間・3社間の両方のファクタリングに対応しており、取引先との関係性やコストのバランスを考慮した最適な方式を提案してくれます。手数料は2%〜（上限非公開・公式サイトにて2026年6月確認）で、最短即日での入金が可能です。詳細は公式サイトでご確認ください。
          </p>
          <p className="mb-4 leading-relaxed text-text-light">
        ...
        <section className="mb-16">
          ...
          <p className="leading-relaxed text-text-light">
            一方で、公式の手数料は2%〜（上限非公開・公式サイトにて2026年6月確認）で、小口案件では下限より高い料率が適用される場合があります。手数料よりも対応の丁寧さや小口案件への柔軟性を重視する方にとっては、最適な選択肢の一つです。詳細は公式サイトでご確認ください。
          </p>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="rounded-lg border border-border bg-white p-5">
            ...
            <p className="text-sm leading-relaxed text-text-light">
              アクセルファクターは手数料0.5%〜12.0%で30万〜1億円に対応しています。メンターキャピタルは手数料2%〜（上限非公開・公式サイトにて2026年6月確認）で同じく30万〜1億円ですが、300万円以下の小口案件に特化しています。手数料の下限はアクセルファクターが0.5%〜、メンターキャピタルが2%〜と差がありますが、小口案件の丁寧さではメンターキャピタルに強みがあります。詳細は公式サイトでご確認ください。
            </p>
          </div>
        </section>
