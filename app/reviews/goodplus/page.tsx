...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/reviews/goodplus/",
  },
  openGraph: {
    title:
      "GoodPlusの口コミ・評判｜最短90分のオンラインファクタリングを検証",
    ...
    url: "https://hyogo-shihoushoshi.jp/reviews/goodplus/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://hyogo-shihoushoshi.jp/reviews/goodplus/",
  },
};
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <div className="mb-8 rounded-xl border-2 border-primary/30 bg-primary-light/40 p-5 md:p-6">
          ...
          <p className="text-sm leading-relaxed text-text-main">
            GoodPlusは、最短90分の高速入金と完全オンライン完結を重視し、15万円からの少額を売掛先に知られず現金化したい法人・個人事業主に向いたサービスです。手数料は5%〜15%（公式サイトにて2026年6月確認）で、2社間ファクタリングのため売掛先への通知はありません。一方、手数料の安さを最優先する方や、買取上限5,000万円を超える大口案件には不向きです。
          </p>
