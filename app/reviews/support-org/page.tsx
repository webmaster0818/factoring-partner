      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <div className="mb-8 rounded-xl border-2 border-primary/30 bg-primary-light/40 p-5 md:p-6">
          ...
          <p className="text-sm leading-relaxed text-text-main">
            日本中小企業金融サポート機構は、非営利の一般社団法人という運営形態の安心感と、審査通過率95%（公式発表）の柔軟な審査を重視する法人・個人事業主に向いたサービスです。手数料は公式表記で1.5%〜（上限非公表・公式サイトにて2026年6月確認）、オンラインに加えFAX・郵送でも手続きでき、最短即日入金に対応します。一方、繁忙期は対応が遅れる場合があり、郵送対応では入金まで数日かかるため、スピードを最優先する方には不向きです。
          </p>
        ...
        <section id="reviews" className="mb-16">
          ...
          <div className="mb-8 rounded-lg border border-border bg-section-bg p-4 text-xs text-text-light leading-relaxed">
            ...
            <p className="text-xs text-gray-400 mt-2">出典: <a href="https://faclog.jp/factor/nihon-chushokigyo-support" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600">ファクログ</a> / <a href="https://growth-partners.co.jp/japan-sme-financial-support-association-reputation/" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-600">GROWTH PARTNERS</a></p>
          </div>
