...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://hyogo-shihoushoshi.jp/reviews/accelfactor/",
  },
  openGraph: {
    title:
      "アクセルファクターの口コミ・評判｜審査通過率93.3%の実力を検証",
    ...
    url: "https://hyogo-shihoushoshi.jp/reviews/accelfactor/",
    type: "article",
  },
};
...
const basicInfo = [
  { label: "手数料", value: "0.5%〜（3社間：0.5%〜10.5% / 2社間：1.0%〜12.0%）※公式サイトにて2026年6月確認" },
...
const demerits = [
  ...
  },
  {
    title: "手数料の幅が広い",
    description:
      "手数料0.5%〜と表示されていますが、実際に最低水準が適用されるケースは限定的です。公式表記では3社間0.5%〜10.5%・2社間1.0%〜12.0%（公式サイトにて2026年6月確認）と幅が広いため、必ず見積もりで正確な手数料を確認することが重要です。",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "手数料0.5%が適用されるのは、3社間ファクタリングで売掛先が非常に信用力の高い大手企業、かつ金額が大きい案件など、条件が揃った場合に限られます。公式表記では3社間0.5%〜10.5%・2社間1.0%〜12.0%（公式サイトにて2026年6月確認）とされており、実際の料率は案件ごとに変動します。正確な手数料は見積もりで確認してください。詳細は公式サイトでご確認ください。",
  },
  {
    question: "即日入金は可能ですか？",
    answer:
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://hyogo-shihoushoshi.jp/reviews/accelfactor/",
  },
};
    ...
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        <section className="mb-10 rounded-xl border border-primary/30 bg-primary/5 p-6">
          <p className="mb-3 text-sm font-bold text-primary">アクセルファクターをさらに詳しく</p>
          <ul className="grid gap-2 text-sm md:grid-cols-3">
            <li><Link href="/reviews/accelfactor/shinsa/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">審査は厳しい？通過のコツ</Link></li>
            <li><Link href="/reviews/accelfactor/documents/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">必要書類と入金までの流れ</Link></li>
            <li><Link href="/reviews/accelfactor/fee/" className="font-bold text-primary underline underline-offset-2 hover:opacity-80">手数料の実際と他社比較</Link></li>
          </ul>
        </section>
