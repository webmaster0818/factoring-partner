...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/reviews/kensetsukun/",
  },
  openGraph: {
    title:
      "けんせつくんの口コミ・評判｜建設業特化ファクタリングを検証",
    ...
    url: "https://hyogo-shihoushoshi.jp/reviews/kensetsukun/",
    type: "article",
  },
};
...
const badReviews = [
  ...
  },
  {
    ...
    label: "建設業の利用者",
    detail:
      "手数料が2%〜と下限のみ公開されており、上限が明示されていないため、見積もりを取るまで実際のコストがわかりにくいという声があります。透明性の面でやや不安を感じるという指摘があります。",
  },
  {
    title: "口コミ・評判の情報が少ない",
    label: "建設業の経営者",
...
const demerits = [
  ...
  },
  {
    title: "手数料の上限が不明瞭",
    description:
      "手数料は2%〜と下限のみが公開されており、上限が明示されていません。案件ごとに個別見積もりとなるため、事前にコストの目安をつけにくい面があります。見積もりを取る際は、必ず手数料の具体的な数値を確認しましょう。",
  },
  {
...
const faqs = [
  {
    ...
    answer:
      "手数料は2%〜（上限非公開、公式サイトにて2026年6月確認）で、案件ごとに個別見積もりとなります。元請けの信用力、工事の規模、支払いサイトなどにより手数料が変動します。具体的な手数料は見積もり時に提示されるため、まずは問い合わせて確認することをおすすめします。",
  },
  {
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://hyogo-shihoushoshi.jp/reviews/kensetsukun/",
  },
};
