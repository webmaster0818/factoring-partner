...
export const categories: Category[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      { slug: "sakibarai-kaitori-shinsa-nashi", label: "先払い買取に審査がないのはなぜか（構造の危険サイン）" },
      { slug: "sakibarai-kaitori-zaiseki-kakunin", label: "先払い買取に在籍確認・職場連絡はある？" },
      { slug: "sakibarai-kaitori-5ch-hyoban", label: "先払い買取の5ch・知恵袋の評判はどこまで信用できる？" },
