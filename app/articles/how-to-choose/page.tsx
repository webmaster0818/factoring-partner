...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/how-to-choose/",
  },
  openGraph: {
    title: "ファクタリング会社の選び方完全ガイド｜10のチェックポイント",
    description: "ファクタリング会社の選び方を10のチェックポイントで解説。失敗しない選び方のコツ。",
    url: "https://hyogo-shihoushoshi.jp/articles/how-to-choose/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/how-to-choose/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "ファクタリング会社の選び方", item: "https://hyogo-shihoushoshi.jp/articles/how-to-choose/" },
  ],
};
