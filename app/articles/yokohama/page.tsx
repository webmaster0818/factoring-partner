...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/yokohama/",
  },
  openGraph: {
    title: "ファクタリング 横浜のおすすめ業者5選｜神奈川エリア対応",
    description: "横浜・神奈川エリアのファクタリング会社5社を手数料・スピードで比較。",
    url: "https://hyogo-shihoushoshi.jp/articles/yokohama/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/yokohama/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "横浜のファクタリング会社", item: "https://hyogo-shihoushoshi.jp/articles/yokohama/" },
  ],
};
