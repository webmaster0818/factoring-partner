...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://hyogo-shihoushoshi.jp/articles/double-assignment/" },
  openGraph: { title: "ファクタリングの二重譲渡とは？リスクと回避方法を解説", description: "二重譲渡のリスクと回避方法を法的根拠から解説。", url: "https://hyogo-shihoushoshi.jp/articles/double-assignment/", type: "article" },
};
...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", image: "https://hyogo-shihoushoshi.jp/og-image.png", headline: "ファクタリングの二重譲渡とは？リスクと回避方法を解説", description: "二重譲渡のリスクと回避方法を法的根拠から解説。", datePublished: "2026-04-26", dateModified: "2026-04-26", author: { "@type": "Person", name: "ファクタリングパートナー 編集部", url: "https://hyogo-shihoushoshi.jp/about/" }, publisher: { "@type": "Organization", name: "ファクタリングパートナー", url: "https://hyogo-shihoushoshi.jp" }, mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/double-assignment/" } };
const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: faqs.map((faq) => ({ "@type": "Question", name: faq.question, acceptedAnswer: { "@type": "Answer", text: faq.answer } })) };
const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "ホーム", item: "https://hyogo-shihoushoshi.jp/" }, { "@type": "ListItem", position: 2, name: "コラム", item: "https://hyogo-shihoushoshi.jp/articles/" }, { "@type": "ListItem", position: 3, name: "二重譲渡のリスクと回避方法", item: "https://hyogo-shihoushoshi.jp/articles/double-assignment/" }] };
