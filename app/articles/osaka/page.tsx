...
const faqs = [
  {
    ...
    answer:
      "大阪で選ぶ際は、①大阪に拠点があり対面相談が可能か②手数料が相場（2社間8〜18%、3社間1〜9%）の範囲内か③即日入金に対応しているか④自社の業種に対応しているか⑤口コミ・実績が豊富かの5点を確認しましょう。大阪拠点の会社と東京のオンライン対応の会社を組み合わせて比較すると、より有利な条件が見つかります。",
  },
  {
    question: "大阪のファクタリング手数料の相場は？",
    answer:
      "大阪のファクタリング手数料は、2社間で8%〜18%、3社間で1%〜9%程度が相場で、東京とほぼ同水準です。ただし、大阪拠点の会社は東京の大手に比べて手数料交渉に柔軟な傾向があります。複数社の見積もりを比較して値引き交渉を行うことで、さらに安くなる可能性があります。",
  },
  {
