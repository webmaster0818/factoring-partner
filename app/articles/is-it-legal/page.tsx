...
const badCompanySigns = [
  ...
  },
  {
    ...
    description:
      "2社間ファクタリングの相場は8%〜18%、3社間は1%〜9%です（会社により異なる目安）。相場から極端に外れた手数料を提示する業者には注意しましょう。極端に安い場合は後から追加費用を請求されるリスク、極端に高い場合は出資法違反の可能性があります。",
  },
  {
    title: "担保や保証人を要求する",
    description:
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 rounded-lg bg-section-bg p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-text-light">
                    2社間：8%〜18%、3社間：1%〜9%が目安（会社による）。極端に安い・高い場合は要注意
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-lg bg-section-bg p-4">
