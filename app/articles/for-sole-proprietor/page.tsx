...
const top5 = [
  ...
  },
  {
    ...
    description:
      "ラボルは東証プライム上場企業・株式会社セレスの100%子会社が運営するファクタリングサービスです。手数料一律10%・最短60分入金で、買取上限額に制限がないのが大きな強み。土日祝日を含む24時間365日対応しているため、急な資金需要にも対応できます。運営企業の信頼性も高く、安心して利用できます。",
  },
  {
    rank: 3,
    name: "QuQuMo",
    ...
    description:
      "QuQuMo（ククモ）はオンライン完結型のファクタリングサービスで、手数料1%〜（上限非公表）で下限は業界最安水準です。買取金額に上限・下限がなく、少額から大口まで柔軟に対応。弁護士ドットコム監修のクラウドサインを使った電子契約で、安全かつスピーディーに取引できます。個人事業主の利用も多く、使いやすいと評判です。",
  },
  {
    rank: 4,
    name: "アクセルファクター",
...
const selectionGuide = [
  ...
  },
  {
    priority: "手数料の安さ最優先",
    recommended: "QuQuMo",
    reason: "手数料1%〜（上限非公表）。売掛先が大手企業なら1%台も狙える。",
  },
  {
