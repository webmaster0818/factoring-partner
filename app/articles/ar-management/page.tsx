...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://hyogo-shihoushoshi.jp/articles/ar-management/" },
  openGraph: { title: "売掛金管理の基本とファクタリング活用術｜回収リスクを減らす", description: "売掛金管理の基本とファクタリング活用術を解説。", url: "https://hyogo-shihoushoshi.jp/articles/ar-management/", type: "article" },
};
      ...
      <section className="mb-12">
        <div className="rounded-lg border border-primary/20 bg-primary-light p-6">
          ...
          <li><Link href="/ranking/" className="font-medium text-primary underline">おすすめファクタリング会社ランキング</Link>｜編集部が厳選した順位で比較できます。</li>
                    <li><Link href="/articles/cashflow-statement/" className="font-medium text-primary underline">キャッシュフロー計算書の読み方</Link>｜資金繰りの全体像を会計面から把握できます。</li>
          </ul>
        </div>
      </section>
