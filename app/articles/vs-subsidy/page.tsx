...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/vs-subsidy/",
  },
  openGraph: {
    title: "ファクタリング vs 補助金・助成金｜併用可能？メリットデメリット比較",
    description: "ファクタリングと補助金・助成金の違いと併用方法を解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/vs-subsidy/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/vs-subsidy/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "vs 補助金・助成金", item: "https://hyogo-shihoushoshi.jp/articles/vs-subsidy/" },
  ],
};
