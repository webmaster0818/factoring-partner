...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/large-amount/",
  },
  openGraph: {
    title: "大口ファクタリング｜1億円超の高額取引に対応するおすすめ会社",
    description: "1億円超対応の大口ファクタリング会社5選。手数料・審査・活用事例を解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/large-amount/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/large-amount/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "大口ファクタリング", item: "https://hyogo-shihoushoshi.jp/articles/large-amount/" },
  ],
};
