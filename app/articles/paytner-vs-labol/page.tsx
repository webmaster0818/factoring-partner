...
const comparisonItems = [
  ...
  { item: "入金スピード", paytner: "最短10分", labol: "最短60分" },
...
const laborWeaknesses = [
  {
    ...
    description:
      "ラボルの入金スピードは最短60分で、ペイトナーの最短10分と比較するとやや遅めです。ただし、30分でも十分に速いスピードであり、多くの利用者にとっては問題にならない範囲です。",
  },
  {
    title: "必要書類がやや多い",
    description:
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "はい、ラボルは24時間365日の審査・入金に対応しています。土日祝日や年末年始でも利用可能で、最短60分で入金されます。銀行の営業時間外でも対応できるよう、振込方法が工夫されています。",
  },
  {
