...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/bankruptcy-risk/",
  },
  openGraph: {
    title: "売掛先が倒産したらどうなる？償還請求権とファクタリングの安全性",
    description:
      "売掛先倒産時のリスクと償還請求権の仕組み。ノンリコース契約の重要性を解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/bankruptcy-risk/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/bankruptcy-risk/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "売掛先の倒産リスク", item: "https://hyogo-shihoushoshi.jp/articles/bankruptcy-risk/" },
  ],
};
