...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/bulk-estimate/",
  },
  openGraph: {
    title: "ファクタリング一括見積もりサイト比較｜複数業者で最安を見つける方法",
    description:
      "ファクタリングの一括見積もりで最安値を見つける方法。仕組みとメリット・デメリットを解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/bulk-estimate/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/bulk-estimate/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "一括見積もり比較", item: "https://hyogo-shihoushoshi.jp/articles/bulk-estimate/" },
  ],
};
