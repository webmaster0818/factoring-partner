...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/2sha-ranking/",
  },
  openGraph: {
    title: "2社間ファクタリングおすすめ10選｜取引先に知られず即日資金化",
    description:
      "取引先に知られず即日資金化。2社間ファクタリングのおすすめ10社と選び方を解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/2sha-ranking/",
    type: "article",
  },
};
...
const companies = [
  ...
  { name: "日本中小企業金融サポート機構", fee: "1.5%〜", speed: "最短即日", amount: "上限なし", features: "一般社団法人が運営する非営利型のファクタリングサービス。手数料が業界最安水準。法人・個人事業主対応。経営コンサルティングも提供。" },
  { name: "QuQuMo（ククモ）", fee: "1%〜", speed: "最短2時間", amount: "上限なし", features: "完全オンライン完結型。クラウドサインによる電子契約。必要書類は請求書と通帳コピーの2点のみ。法人の大口案件にも対応。" },
  { name: "アクセルファクター", fee: "0.5%〜12.0%", speed: "最短即日", amount: "30万〜1億円", features: "審査通過率93%以上。年間相談件数15,000件以上。少額から利用可能。赤字決算・税金滞納でも柔軟に対応。個人事業主OK。" },
  ...
  { name: "トップ・マネジメント", fee: "3.5%〜", speed: "最短即日", amount: "30万〜3億円", features: "創業15年以上の実績。最大3億円の高額買取に対応。法人専用。対面・オンラインどちらも対応可能。注文書ファクタリングにも対応。" },
];
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/2sha-ranking/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "2社間ファクタリングおすすめ", item: "https://hyogo-shihoushoshi.jp/articles/2sha-ranking/" },
  ],
};
