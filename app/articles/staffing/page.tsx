...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/staffing/",
  },
  openGraph: {
    title: "人材派遣向けファクタリング｜給与支払い資金の調達方法",
    description: "人材派遣業の資金繰り課題をファクタリングで解決。おすすめ5社と活用事例を紹介。",
    url: "https://hyogo-shihoushoshi.jp/articles/staffing/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/staffing/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "人材派遣向けファクタリング", item: "https://hyogo-shihoushoshi.jp/articles/staffing/" },
  ],
};
