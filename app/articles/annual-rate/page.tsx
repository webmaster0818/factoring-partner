...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://hyogo-shihoushoshi.jp/articles/annual-rate/" },
  openGraph: { title: "ファクタリング手数料を年利換算すると？銀行融資との比較", description: "ファクタリング手数料の年利換算と銀行融資との比較。", url: "https://hyogo-shihoushoshi.jp/articles/annual-rate/", type: "article" },
};
