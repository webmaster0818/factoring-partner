...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/vs-crowdfunding/",
  },
  openGraph: {
    title: "ファクタリング vs クラウドファンディング｜資金調達手段を徹底比較",
    description: "ファクタリングとクラウドファンディングの違いを比較。資金調達に最適な手段を解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/vs-crowdfunding/",
    type: "article",
  },
};
...
const comparisonItems = [
  ...
  { label: "調達コスト", factoring: "手数料1%〜18%程度", crowdfunding: "プラットフォーム手数料10%〜20%+リターン費用" },
...
const faqs = [
  ...
  },
  {
    ...
    answer: "一概には言えません。ファクタリングの手数料は1%〜18%程度ですが、クラウドファンディングはプラットフォーム手数料（10%〜20%）に加えてリターンの原価や送料がかかります。購入型クラウドファンディングのトータルコストは20%〜40%になることもあり、コスト面ではファクタリングのほうが安い場合が多いです。",
  },
];
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/vs-crowdfunding/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "vs クラウドファンディング", item: "https://hyogo-shihoushoshi.jp/articles/vs-crowdfunding/" },
  ],
};
      ...
      <section className="mb-12">
        <div className="rounded-lg border border-primary/20 bg-primary-light p-6">
          ...
          <li><Link href="/ranking/" className="font-medium text-primary underline">おすすめファクタリング会社ランキング</Link>｜編集部が厳選した順位で比較できます。</li>
                    <li><Link href="/articles/funding-methods/" className="font-medium text-primary underline">資金調達手段の一覧ガイド</Link>｜15の資金調達方法を横断比較できます。</li>
