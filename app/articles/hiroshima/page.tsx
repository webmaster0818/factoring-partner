...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/hiroshima/",
  },
  openGraph: {
    title: "ファクタリング 広島のおすすめ業者5選｜中国地方対応",
    description: "広島・中国地方のファクタリング会社5社を手数料・スピードで比較。",
    url: "https://hyogo-shihoushoshi.jp/articles/hiroshima/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/hiroshima/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "広島のファクタリング会社", item: "https://hyogo-shihoushoshi.jp/articles/hiroshima/" },
  ],
};
