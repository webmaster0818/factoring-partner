...
const faqs = [
  { question: "仙台で即日入金は可能ですか？", answer: "オンライン完結型の会社であれば来店不要で、最短即日入金に対応するサービスがあります（対応可否・条件は本ページの比較表と各社公式サイトをご確認ください）。午前中の申込みと、請求書・入出金明細など書類の事前準備が当日入金の実務上の鍵になります。" },
  {
    question: "仙台でファクタリング会社を選ぶ際のポイントは？",
    answer:
      "仙台で選ぶ際は、①オンラインで完結できるか②手数料が相場範囲内（2社間8〜18%、3社間1〜9%）か③東北の主要業種に対応しているか④即日入金に対応しているか⑤実績と口コミが豊富かの5点を確認しましょう。東京の大手もオンラインで利用できるため、選択肢を広く持つことが重要です。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "仙台のファクタリング手数料は、2社間で8%〜18%、3社間で1%〜9%程度で、東京とほぼ同水準です。オンライン対応の全国展開型会社を利用することで、地域差なく競争力のある手数料で利用できます。複数社の見積もりを必ず比較しましょう。",
  },
  {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-14">
        ...
        {/* ── 即日入金 ─── */}
        <section className="mb-16">
          <h2 className="mb-6 border-l-4 border-primary pl-4 text-xl font-bold text-text-main md:text-2xl">仙台で即日入金を狙うなら</h2>
          <p className="mb-4 leading-relaxed text-text-light">
            仙台からでも、オンライン完結型のファクタリングなら来店不要で申し込めます。本ページの比較表にある「最短即日」対応の会社を選び、<strong className="text-text-main">午前中の早い時間に申し込む・請求書と入出金明細を事前に揃えておく</strong>ことが、当日中の入金可否を分ける実務上のポイントです。
          </p>
