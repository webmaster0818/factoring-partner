...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/vs-abl/",
  },
  openGraph: {
    title: "ABL（動産担保融資）vs ファクタリング｜違いと使い分けを解説",
    description: "ABLとファクタリングの違いを比較。どちらが自社に適しているか判断できます。",
    url: "https://hyogo-shihoushoshi.jp/articles/vs-abl/",
    type: "article",
  },
};
...
const comparisonItems = [
  ...
  { label: "コスト", abl: "年利2%〜8%程度", factoring: "手数料1%〜18%程度（1回あたり）" },
...
const ablMerits = [
  { title: "金利が低い", description: "年利2%〜8%と、ファクタリングの手数料（1回あたり1%〜18%程度）と比較して長期的なコストが安くなります。" },
...
const faqs = [
  ...
  },
  {
    ...
    answer: "長期的・継続的な資金需要であればABLのほうがコストが安くなります。ABLの年利2%〜8%は、ファクタリングの手数料（1回あたり1%〜18%程度）と比較してかなり低いです。一方、短期的・単発の資金需要であればファクタリングのほうがスピーディーで手続きも簡単です。",
  },
  {
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/vs-abl/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "ABL vs ファクタリング", item: "https://hyogo-shihoushoshi.jp/articles/vs-abl/" },
  ],
};
