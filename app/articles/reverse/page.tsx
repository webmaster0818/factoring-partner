...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/reverse/",
  },
  openGraph: {
    title: "リバースファクタリングとは？買掛金の早期支払いで取引先を支援",
    description: "リバースファクタリングの仕組み・メリット・通常ファクタリングとの違いを解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/reverse/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/reverse/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "リバースファクタリング", item: "https://hyogo-shihoushoshi.jp/articles/reverse/" },
  ],
};
