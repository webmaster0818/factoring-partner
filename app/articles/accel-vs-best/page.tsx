...
const accelWeaknesses = [
  {
    title: "手数料の上限が20%と高め",
    description:
      "アクセルファクターの手数料レンジは2%〜20%で、上限の20%はやや高めです。売掛先の信用力が低い場合や少額案件では、手数料が高くなる可能性があります。手数料上限を重視する場合はビートレーディング（12%）やOLTA（9%）も検討対象です。",
  },
  {
    title: "累計実績の公表が限定的",
    description:
...
const faqs = [
  {
    ...
    answer:
      "どちらも手数料レンジは2%〜20%で同等です。実際に適用される手数料は売掛先の信用力・売掛金の金額・支払いサイトによって異なるため、同じ売掛債権で両社から見積もりを取って比較することをおすすめします。手数料の安さを最重視する場合は、ビートレーディング（4%〜12%）やQuQuMo（1%〜14.8%）も検討してみてください。",
  },
  {
        ...
        <section id="comparison" className="mb-16">
          ...
          <div className="mt-4 rounded-lg bg-primary-light p-4">
            <p className="text-sm leading-relaxed text-text-light">
              <strong className="text-primary">ポイント：</strong>手数料レンジは同等。アクセルファクターは審査通過率93.3%の安心感、ベストファクターは財務コンサルティング的なサポートが強みです。
            </p>
          </div>
        </section>
