...
const speedRanking = [
  ...
  { rank: 2, name: "ラボル", speed: "最短60分", fee: "一律10%", target: "個人・法人", online: "完全対応", note: "24時間365日・土日祝も入金対応" },
  { rank: 3, name: "PAYTODAY", speed: "最短30分", fee: "1%〜9.5%", target: "個人・法人", online: "完全対応", note: "AI審査で高速処理。手数料も安い" },
  { rank: 4, name: "QuQuMo", speed: "最短2時間", fee: "1%〜", target: "個人・法人", online: "完全対応", note: "手数料1%〜の低コスト。電子契約対応" },
  { rank: 5, name: "ビートレーディング", speed: "最短2時間", fee: "2%〜12%", target: "法人中心", online: "対応", note: "大手の安心感。大口案件にも即日対応" },
  { rank: 6, name: "アクセルファクター", speed: "最短3時間", fee: "0.5%〜12.0%", target: "個人・法人", online: "対応", note: "審査通過率93.3%。審査に不安がある方向け" },
...
const detailedDescriptions = [
  ...
  },
  {
    name: "ラボル",
    description:
      "ラボルは24時間365日・土日祝日でも最短60分で入金される唯一無二のファクタリングサービスです。東証プライム上場企業・株式会社セレスの100%子会社が運営しているため、信頼性も抜群。手数料は一律10%で、買取上限に制限がありません。金曜の夜や週末に急な資金需要が発生した場合に、最も頼りになるサービスです。独自の送金システムにより銀行の営業時間に関係なく入金が可能です。",
  },
  {
    name: "PAYTODAY",
    description:
...
const instantFlowSteps = [
  ...
  {
    step: "5. 入金（即時〜当日中）",
    description: "契約締結後、指定の銀行口座に入金されます。ペイトナーは最短10分、ラボルは最短60分で入金。銀行の営業時間内（15時まで）に契約が完了すれば、当日中の入金が期待できます。",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "はい、条件を満たせば即日入金が可能です。ペイトナーは最短10分、ラボルは最短60分で入金された実績があります。ただし、初回利用時は審査に時間がかかる場合があり、午後の遅い時間の申し込みは翌営業日になることもあります。確実に即日入金を受けたい場合は、午前中に申し込むことをおすすめします。",
  },
  {
    question: "土日でも即日入金してもらえるファクタリング会社はありますか？",
    answer:
      "ラボルは24時間365日対応しており、土日祝日でも最短60分で入金可能です。ペイトナーも土日の審査に対応していますが、振込は翌営業日になる場合があります。その他の多くのファクタリング会社は平日のみの対応です。",
  },
  {
        ...
        <section id="weekend" className="mb-16">
          ...
          <div className="mt-6 rounded-lg border border-secondary/30 bg-teal-50 p-6">
            ...
            <p className="text-sm leading-relaxed text-text-light">
              土日祝日に確実に入金してもらいたい場合は、<strong className="text-text-main">ラボル</strong>が最も確実です。24時間365日対応で、銀行振込ではなく独自の送金システムを使っているため、土日でも最短60分で入金されます。次点ではペイトナーが審査は土日対応していますが、振込は翌営業日になる場合がある点に注意しましょう。
            </p>
          </div>
        </section>
