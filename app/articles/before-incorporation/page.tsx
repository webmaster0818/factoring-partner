...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/before-incorporation/",
  },
  openGraph: {
    title: "個人事業主が法人成りする前のファクタリング活用法",
    description: "法人成り前の資金繰り課題をファクタリングで解決。活用法と注意点を解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/before-incorporation/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/before-incorporation/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "法人成り前のファクタリング活用法", item: "https://hyogo-shihoushoshi.jp/articles/before-incorporation/" },
  ],
};
