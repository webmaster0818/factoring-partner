...
const feeRanking = [
  ...
  { rank: 8, name: "トップ・マネジメント", fee: "3.5%〜", type: "2社間・3社間", note: "大口案件なら手数料交渉が可能" },
              ...
              >
                ...
                <section className="mb-12">
                  <div className="rounded-lg border border-primary/20 bg-primary-light p-6">
                    ...
                    <li><Link href="/articles/fee-guide/" className="font-medium text-primary underline">ファクタリング手数料の相場ガイド</Link>｜相場・内訳・安く抑えるコツを総まとめしています。</li>
                    </ul>
                  </div>
                </section>
