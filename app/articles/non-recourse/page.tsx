...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/non-recourse/",
  },
  openGraph: {
    title: "ファクタリングのノンリコースとウィズリコースの違いを解説",
    description: "ノンリコースとウィズリコースの違いを比較。選び方のポイントも解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/non-recourse/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/non-recourse/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "ノンリコースとウィズリコースの違い", item: "https://hyogo-shihoushoshi.jp/articles/non-recourse/" },
  ],
};
      ...
      <section className="mb-12">
        <div className="rounded-lg border border-primary/20 bg-primary-light p-6">
          ...
          <li><Link href="/ranking/" className="font-medium text-primary underline">おすすめファクタリング会社ランキング</Link>｜編集部が厳選した順位で比較できます。</li>
                    <li><Link href="/articles/what-is-factoring/" className="font-medium text-primary underline">ファクタリングとは（仕組みの基本）</Link>｜2社間・3社間の違いや流れを図解でまとめています。</li>
