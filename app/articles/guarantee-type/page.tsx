...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/guarantee-type/",
  },
  openGraph: {
    title: "保証型ファクタリングとは？買取型との違い・手数料・活用シーン",
    description: "保証型ファクタリングの仕組み・手数料・活用シーンを解説。買取型との違いも紹介。",
    url: "https://hyogo-shihoushoshi.jp/articles/guarantee-type/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/guarantee-type/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "保証型ファクタリング", item: "https://hyogo-shihoushoshi.jp/articles/guarantee-type/" },
  ],
};
