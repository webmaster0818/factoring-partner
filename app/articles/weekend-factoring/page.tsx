...
const weekendCompanies = [
  {
    ...
    online: "完全対応",
    detail:
      "ラボルは東証プライム上場企業・株式会社セレスの100%子会社が運営するファクタリングサービスです。最大の特徴は24時間365日・土日祝日でも最短60分で入金される点。独自の送金システムを採用しており、銀行の営業時間に関係なく即座に入金が可能です。手数料は一律10%と明確で、買取上限に制限がありません。金曜夜や週末に急な資金需要が発生した場合に、最も頼りになるサービスです。フリーランスや個人事業主を中心に利用者が急増しています。",
  },
  {
    rank: 2,
    name: "ペイトナー",
  ...
  },
  {
    ...
    online: "完全対応",
    detail:
      "QuQuMoはオンライン完結型のファクタリングサービスで、手数料1%〜（上限非公表）の低コストが魅力です。土日祝日の対応はしていませんが、完全オンライン完結なので平日であれば全国どこからでもスピーディーに利用できます。必要書類は請求書・通帳・本人確認書類の3点のみで、電子契約に対応。債権譲渡登記も不要なため、追加コストがかかりません。",
  },
];
...
const bankingNotes = [
  ...
  },
  {
    title: "ラボルの独自送金システム",
    description:
      "ラボルは銀行振込とは異なる独自の送金システムを採用しています。そのため、銀行の営業時間やモアタイムシステムの制約を受けず、土日祝日・深夜でも最短60分で入金が完了します。受取側の口座の種類に関係なく入金されるため、ネット銀行でなくても利用可能です。",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "はい、ラボルは24時間365日対応で、土日祝日でも最短60分で入金されます。独自の送金システムにより銀行の営業時間に関係なく入金が可能です。ペイトナーも土日に審査を実施しますが、振込は翌営業日になる場合があります。確実に土日に入金を受けたい場合はラボルがおすすめです。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "ラボル以外のファクタリング会社の場合、金曜の夕方（15時以降）の申し込みは翌営業日の月曜日に対応されるケースがほとんどです。ラボルなら24時間365日対応のため、金曜の夕方や夜に申し込んでも最短60分で入金されます。週末前に急いで資金が必要な場合は、ラボルの利用を検討してください。",
  },
  {
    question: "土日対応のファクタリング会社は手数料が高いですか？",
    answer:
      "はい、やや高めの傾向があります。土日対応のラボルとペイトナーは手数料一律10%で、平日のみ対応のPAYTODAY（1%〜9.5%）やQuQuMo（1%〜・上限非公表）と比べると割高です。ただし、手数料10%でも緊急の資金需要に対応できるメリットは大きいため、状況に応じて使い分けるのが賢い方法です。",
  },
  {
          ...
          <div className="space-y-4">
            <div className="rounded-lg border border-border bg-white p-6">
              ...
              <p className="leading-relaxed text-text-light">
                ラボル一択です。24時間365日対応で、独自送金システムにより土日でも最短60分で入金されます。手数料は一律10%ですが、休日に確実に資金を手にできる唯一のサービスです。事前にアカウント登録を済ませておくと、申し込みから入金まで30分程度で完了します。
              </p>
            </div>
            <div className="rounded-lg border border-border bg-white p-6">
            ...
            <div className="rounded-lg border border-border bg-white p-6">
              ...
              <p className="leading-relaxed text-text-light">
                急ぎでなければ、金曜の午前中にPAYTODAY（手数料1%〜9.5%）やQuQuMo（手数料1%〜）に申し込むのがベストです。平日対応のため土日は利用できませんが、手数料が大幅に安くなります。100万円のファクタリングなら、10%と5%の差額は5万円にもなります。
              </p>
            </div>
          </div>
        </section>
              ...
              >
                ...
                <section className="mb-12">
                  <div className="rounded-lg border border-primary/20 bg-primary-light p-6">
                    <p className="mb-3 font-bold text-primary">今すぐ・即日で資金化したい方へ</p>
                    <ul className="space-y-2 text-sm text-text-light">
