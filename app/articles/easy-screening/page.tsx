...
const top8 = [
  ...
  { rank: 4, name: "ラボル", passRate: "非公開（高い）", fee: "一律10%", speed: "最短60分", note: "24時間365日対応。必要書類が少なく審査ハードルが低い" },
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "審査結果が出るまでの時間は会社によって異なりますが、ペイトナーは最短10分、ラボルは最短60分、アクセルファクターは最短3時間程度です。オンライン完結型のサービスは審査が早い傾向にあります。対面型のサービスや大口案件は、審査に1〜3営業日かかることもあります。",
  },
];
              ...
              >
                ...
                <section className="mb-12">
                  <div className="rounded-lg border border-primary/20 bg-primary-light p-6">
                    ...
                    <li><Link href="/articles/screening-criteria/" className="font-medium text-primary underline">審査基準の総まとめ</Link>｜通りやすさの条件と必要書類をまとめています。</li>
                    </ul>
                  </div>
                </section>
