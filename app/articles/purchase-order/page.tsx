...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/purchase-order/",
  },
  openGraph: {
    title: "注文書ファクタリングとは？請求書発行前でも資金化できる仕組みを解説",
    description: "注文書（発注書）で請求書前に資金化できるファクタリングの仕組みとおすすめ会社を解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/purchase-order/",
    type: "article",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "注文書ファクタリング", item: "https://hyogo-shihoushoshi.jp/articles/purchase-order/" },
  ],
};
