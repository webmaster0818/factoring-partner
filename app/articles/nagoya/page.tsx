...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/nagoya/",
  },
  openGraph: {
    title: "ファクタリング 名古屋のおすすめ業者5選｜東海エリア対応",
    description: "名古屋・東海エリアのファクタリング会社5社を手数料・スピードで比較。",
    url: "https://hyogo-shihoushoshi.jp/articles/nagoya/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/nagoya/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "名古屋のファクタリング会社", item: "https://hyogo-shihoushoshi.jp/articles/nagoya/" },
  ],
};
