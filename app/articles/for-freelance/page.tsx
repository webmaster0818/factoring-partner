...
const top5 = [
  ...
  },
  {
    ...
    description:
      "ラボルは24時間365日対応のファクタリングサービスで、土日祝日でも最短60分で入金されます。東証プライム上場企業・株式会社セレスの100%子会社が運営しているため、信頼性は抜群。買取上限に制限がなく、フリーランスの大型案件にも対応できます。「金曜の夜に急な出費が発生した」という場合でも即座に対応可能です。",
  },
  {
    rank: 3,
  ...
  },
  {
    ...
    description:
      "QuQuMo（ククモ）は手数料1%〜（上限非公表）で下限は業界最安水準のファクタリングサービスです。完全オンラインで手続きが完結し、来店不要。弁護士ドットコムのクラウドサインを使った電子契約で安全性も確保されています。手数料を最小限に抑えたいフリーランスに最適で、売掛先が大手企業なら1%台の手数料で利用できる可能性もあります。",
  },
  {
    rank: 5,
    name: "PAYTODAY",
...
const feeComparison = [
  ...
  { name: "QuQuMo", fee: "1%〜", note: "大手取引先なら低手数料" },
              ...
              >
                ...
                <section className="mb-12">
                  <div className="rounded-lg border border-primary/20 bg-primary-light p-6">
                    <p className="mb-3 font-bold text-primary">対象（法人・個人事業主）で選ぶ</p>
                    <ul className="space-y-2 text-sm text-text-light">
                    <li><Link href="/ranking/" className="font-medium text-primary underline">おすすめファクタリング会社ランキング</Link>｜編集部が厳選した順位で比較できます。</li>
                    <li><Link href="/articles/target-hub/" className="font-medium text-primary underline">対象者別ファクタリングガイド</Link>｜法人・個人事業主・フリーランスなど立場別の選び方をまとめています。</li>
