...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/funding-methods/",
  },
  openGraph: {
    title: "中小企業の資金調達手段一覧（完全版）｜15の方法を比較",
    description: "中小企業の15の資金調達手段を比較。それぞれの特徴と選び方を解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/funding-methods/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/funding-methods/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "中小企業の資金調達手段一覧", item: "https://hyogo-shihoushoshi.jp/articles/funding-methods/" },
  ],
};
