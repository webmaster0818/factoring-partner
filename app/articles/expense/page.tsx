...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://hyogo-shihoushoshi.jp/articles/expense/",
  },
  openGraph: {
    title: "ファクタリング手数料は経費になる？勘定科目と損金算入の解説",
    description:
      "ファクタリング手数料の経費計上方法。勘定科目と損金算入ルールを解説。",
    url: "https://hyogo-shihoushoshi.jp/articles/expense/",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://hyogo-shihoushoshi.jp/articles/expense/" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "手数料の経費計上", item: "https://hyogo-shihoushoshi.jp/articles/expense/" },
  ],
};
