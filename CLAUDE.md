...
## 2026-07-15 「先払い買取」注意喚起記事 新設（MediaXAI「上位5位調査の上コンテンツ設計して作って」）✅
- SERP実査(Google JP相当=Yahoo検索取得。Googleは非JS版廃止でcurl不可→search.yahoo.co.jpで代替): 上位=買取業者コラム/金融庁注意喚起(2位)/先払い買取業者LP/債務整理メディア/弁護士Q&A=警告型が支配的→業者紹介型でなく一次情報の正直解説型で設計
- 【新規】/articles/sakibarai-kaitori/: 5者連名注意喚起(金融庁・消費者庁・警察庁・財務局・貸金業協会=npa.go.jp/bureau/safetylife/keizai/sakibaraikaitori.pdf実取得)ベース。仕組み3step/貸金業法47条2号罰則/危険3つ/危険サイン5/相談窓口4(188・#9110・0570-016811・0570-051051)/比較表(先払い買取vs給与FTvs通常買取vs正規FT=上位に無い独自角度)/事業者向け正規代替。特定業者名指しなし・利用推奨なし・FAQ6問schema
- ⚠️出典検証の教訓: 国民生活センターの相談件数(2017-2021年度)をWebFetchが返したが、**実URLをcurl+EUC-JPデコードで検証したら海産物送り付けの別ページ=WebFetch小モデルの捏造**だった→不採用。推測URLの統計は必ず実ページtitleを検証
